...
export class ObInfoRestService {
  ...
  getEstados( codigo: Object ) {
    console.log('http://services.groupkt.com/state/get/' + codigo + '/all');
    return this._http.get('http://services.groupkt.com/state/get/' + codigo + '/all').map(res => res.json());
  }
}
